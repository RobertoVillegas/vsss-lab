...
league-matches-at run_dir matches="100000" capture_every="25" capture_seconds="60" checkpoint_every="25" device="auto" num_envs="64" config="experiments/configs/m13-mappo-directional.toml":
  mise run train-env
...
league-steps-at run_dir steps="20000000" capture_every="25" capture_seconds="60" checkpoint_every="25" device="auto" num_envs="64" config="experiments/configs/m13-mappo-directional.toml":
  mise run train-env

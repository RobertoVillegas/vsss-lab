...
def create_rollout_session(config: MarlConfig, config_json: str, state_json: str) -> RolloutSession:
    ...
    semantic_curriculum = (
        SemanticSkillCurriculum(
            ...
            axis_caps=config.semantic_axis_caps,
        )
    ...
    return RolloutSession(
        environment=VectorMarlMatchEnv(
            ...
            support_formation_coefficient=config.support_formation_coefficient,
            coverage_formation_coefficient=config.coverage_formation_coefficient,
            role_switch_penalty=config.role_switch_penalty,
            role_emergency_margin=config.role_emergency_margin,
            ...
            strike_clearing_enabled=config.strike_clearing_enabled,
            strike_clearing_distance=config.strike_clearing_distance,
        ),

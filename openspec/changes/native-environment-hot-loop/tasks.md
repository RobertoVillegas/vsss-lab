...
- [ ] Add the crate that will hold the ported computation, depending on `vsss-spec` only.
- [ ] Slice 1: observations. Native batch call, golden-equivalence test, throughput reported.

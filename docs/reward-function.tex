...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    Formación dinámica & $0.20$ & Shaping de support y coverage activos \\
...
\Phi_{\mathrm{formation}} &= \frac{1}{|\mathcal{R}_{\mathrm{active}}|}
\sum_{r\in\mathcal{R}_{\mathrm{active}}} q_r,
...
El coeficiente $0.20$ acota su contribución al retorno descontado a dos por ciento del valor de
un gol. Sobre el replay final del run 0013 produjo una magnitud media estimada de
$6.06\times10^{-4}$ por decisión, aproximadamente un tercio del término de transporte del balón.
...
arquitectónica es ADR 0023 y la evidencia se registra en
